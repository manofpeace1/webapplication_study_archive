...
1. Use Google Scripts and copy below script
2. Change header value for authorizations
*/
...
function ImportJSONAdvanced(url, query, options, includeFunc, transformFunc) {
  ...
  var restOptions = {
    "headers" : { "Authorization": "Bearer 3Lb7HmC0EvzeUDyoMJkaup9Pznfugy5fKHegtb77GbwfmJgXRw1hARYrMvpgdeu4"}
    

}

  var jsondata = UrlFetchApp.fetch(url, restOptions);
